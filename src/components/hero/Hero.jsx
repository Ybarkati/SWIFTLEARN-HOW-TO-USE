...
const Hero = () => {
  return (
    <div id="home" className={` bg-gradient-to-r from-white via-blue-100 to-blue-300 `}>
      <div className=" container mx-auto pt-5 h-[750px] md:h-[100vh] md:flex-col-reverse sm:h-[780px]  flex sm:flex-col-reverse sm:pt-0 ">
        <div className=" left mt-4 md:mt-0 flex-1 flex flex-col justify-center gap-5 w-1/2 md:w-full md:py-2 sm:py-0">
          <div className="info w-fit flex flex-col items-start justify-center gap-3 sm:gap-2">
            ...
            >
              Welcome to swiftlearn, platform for:
            </h2>
            <TypeAnimation
              data-aos="fade-up"
              sequence={[
          ...
          <div data-aos="fade-up" className="buttons flex gap-5">
            <a
              target="_blank"
              href="https://swiftlearn-web.onrender.com/auth/sign-up"
        ...
        <div className="right  top-5 flex-1 flex items-center justify-center md:items-end sm:items-end">
          <div className="relative h-[88%] w-fit flex items-center sm:items-end">
            ...
            data-aos="fade-up"
              ...
              src='https://i.postimg.cc/Znq0FjNL/college-homewroks-cuate-1.png'
              // src={mine}
              alt="education"
            />
