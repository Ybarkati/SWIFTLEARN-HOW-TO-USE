    ...
    >
      <nav className=" container m-auto flex items-center justify-between">
        <div data-aos="fade-down" className="logo">
          ...
          >
            <img src="https://i.postimg.cc/rmwtQ8XW/Screenshot-2023-09-05-010146-removebg-preview.png" alt="" className="w-[200px]"/>
          </Link>
        </div>
        <div
          data-aos="fade-down"
        ...
        >
          ...
          >
            ...
            <a
              target="_blank"
              href="https://swiftlearn-web.onrender.com/auth/sign-in"
